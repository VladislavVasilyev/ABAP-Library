...
*╠═══════════════════════════════════════════════════════════════════╣
  loop at <lt_tech_dim>
    ...
    if ld_s__tech_dim-type = zcl_bd00_application=>cs_kf.
      if it_kyf_list is not supplied or it_kyf_list is initial.
      else.
        read table it_kyf_list
             with table key table_line = ld_s__tech_dim-dimension
...
*╚═══════════════════════════════════════════════════════════════════╝
  ...
  loop at e_obj->gd_t__components
    ...
    read table e_obj->gd_t__signeddata
