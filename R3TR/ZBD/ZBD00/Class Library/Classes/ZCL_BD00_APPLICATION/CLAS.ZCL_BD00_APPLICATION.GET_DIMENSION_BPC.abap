method get_dimension_bpc.
  ...
  select dimn~dimension dimn~tech_name
    ...
    where appl~appset_id      = gd_v__appset_id and
          appl~application_id = gd_s__appl_info-application_id
