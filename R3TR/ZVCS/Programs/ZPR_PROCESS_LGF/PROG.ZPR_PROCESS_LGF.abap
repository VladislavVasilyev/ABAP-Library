...
*  gd_s__path-f_ele = f_ele.
  ...
  ZCL_VCS_OBJECTS=>SET_TASK_DOWNLOAD_FOR_BPC( I_T__APPSET_ID = B01_APPS[] I_T__APPL_ID = B01_APPL[] I_S__PATH = GD_S__PATH I_F__LGF = SCLO I_F__PACK = PACK I_F__XLTP = XLTP ).
