method read_objects_choose.
  ...
  data
  : ld_tr__table       type range of tadir-obj_name
  ...
  , <ld_s__rclas>      like line of ld_tr__table
  ...
  loop at cd_t__object assigning <ld_s__object>
    ...
    case <ld_s__object>-type.
      when zvcsc_r3tr_type-devc.
        ...
        endloop.
      when zvcsc_r3tr_type-tabl.
        ld_tr__table = <ld_s__object>-obj_range.
    endcase.

  endloop.

  check ld_tr__table is not initial or ld_tr__devc is not initial.

  select *
    from  tadir as t
      join dd02l as d on d~tabname = t~obj_name
    into  corresponding fields of table ld_t__tadir
    where pgmid    = zvcsc_r3tr
      and object   = zvcsc_r3tr_type-tabl
      and obj_name in ld_tr__table
  ...
  loop at ld_t__tadir assigning <ld_s__tadir>.
    ...
    ld_s__choose-clsname = <ld_s__tadir>-tabclass.
