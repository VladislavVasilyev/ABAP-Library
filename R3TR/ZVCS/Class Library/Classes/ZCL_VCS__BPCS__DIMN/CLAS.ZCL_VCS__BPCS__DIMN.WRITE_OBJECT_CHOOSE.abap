method write_object_choose.
  ...
  data
  : begin of ld_s__dimn_index
    , index type i
    . include type ty_s__dimn.
  data end of ld_s__dimn_index.
  ...
  , ld_v__index         type i
  , ld_t__dimn          like standard table of ld_s__dimn_index
  .
  ...
  loop at gd_t__upload_file assigning <ld_s__upload_file>.
    ...
    ld_s__choose-index = ld_s__dimn_index-index = sy-tabix.
...
*    ld_s__choose-index = <ld_s__dimension>-index = sy-tabix.
    ...
    ld_s__choose-dimension       = ld_s__header-header-obj_name.

    append ld_s__choose to ld_t__choose.

    move-corresponding ld_s__dimn to ld_s__dimn_index.


    concatenate <ld_s__upload_file>-path ld_s__dimn_index-content into ld_s__dimn_index-content.

    append ld_s__dimn_index to ld_t__dimn .
  ...
  loop at ld_t__choose assigning <ld_s__choose>.
    ...
    delete ld_t__dimn where index = ld_v__index.

  endloop.

  loop at ld_t__dimn into ld_s__dimn_index.

    move-corresponding ld_s__dimn_index to  ld_s__dimn.
    append  ld_s__dimn to gd_t__xml.
