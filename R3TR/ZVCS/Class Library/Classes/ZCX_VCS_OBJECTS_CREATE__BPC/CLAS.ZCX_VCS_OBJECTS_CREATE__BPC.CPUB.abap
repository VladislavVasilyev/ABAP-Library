class ZCX_VCS_OBJECTS_CREATE__BPC definition
  public
  inheriting from ZCX_VCS_OBJECTS_CREATE
  final
  create public .

*"* public components of class ZCX_VCS_OBJECTS_CREATE__BPC
...
public section.
  ...
  constants:
    begin of ZCX_VCS_OBJECTS_CREATE__BPC,
    ...
    end of ZCX_VCS_OBJECTS_CREATE__BPC .
