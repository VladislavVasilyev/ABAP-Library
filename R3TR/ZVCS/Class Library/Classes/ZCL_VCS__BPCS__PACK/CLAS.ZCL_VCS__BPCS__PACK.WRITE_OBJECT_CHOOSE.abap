method WRITE_OBJECT_CHOOSE.
  ...
  data
  : begin of ld_s__pack_index
    , index type i
    . include type ty_s__pack.
  data end of ld_s__pack_index.
...
*  , ld_s__dimension     type ty_s__dimension
  ...
  , ld_v__index         type i
  , ld_t__pack          like standard table of ld_s__pack_index
  .
  ...
  loop at gd_t__upload_file assigning <ld_s__upload_file>.
    ...
    ld_s__choose-index = ld_s__pack_index-index = sy-tabix.
...
*    ld_s__choose-index = <ld_s__dimension>-index = sy-tabix.
    ...
    move-corresponding ld_s__pack to ld_s__pack_index.


*    concatenate <ld_s__upload_file>-path ld_s__pack_index-content into ld_s__pack_index-content.

    append ld_s__pack_index to ld_t__pack .
  ...
  loop at ld_t__choose assigning <ld_s__choose>.
    ...
    delete ld_t__pack where index = ld_v__index.

  endloop.

  loop at ld_t__pack into ld_s__pack_index.

    move-corresponding ld_s__pack_index to  ld_s__pack.
