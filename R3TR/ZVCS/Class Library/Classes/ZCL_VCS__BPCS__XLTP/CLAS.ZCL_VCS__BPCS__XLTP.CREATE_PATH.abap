method CREATE_PATH.
  ...
  if i_s__path-f_dir = abap_true.
    case <ld_s__bpcdir>-object.
      when zvcsc_bpc_type-xltp. ld_v__dir = zvcsc_bpc_path-xltp.
    endcase.
  ...
  concatenate <ld_s__bpcdir>-object `.` ld_v__obj_name into e_v__xmlname.

  concatenate <ld_s__bpcdir>-object `.` ld_v__obj_name into e_v__mastername.
  e_v__extsrcname = `bin`.
