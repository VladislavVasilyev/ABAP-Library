method CREATE_PATH.
  ...
  if i_s__path-f_dir = abap_true.
    concatenate ld_v__path zvcsc_r3tr_path-type `\` into ld_v__path.
  endif.
  ...
  concatenate <ld_s__tadir>-object `.` <ld_s__tadir>-obj_name into e_v__mastername.

  e_v__extsrcname = `abap`.
